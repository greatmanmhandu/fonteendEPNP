...
const ReductionProduct = () => {
    ...
    return (
        <div className="newItem-container">
            <div className="text">Stock Adjustment ( Reduction )</div>
        ...
        <Loading />
                    ...
                    <div className="two-together">
                        <div className="form-item">
                            <label htmlFor="stock">Reduction reason</label>
                            <input placeholder='state the reason for reduction' value={reason} style={{ borderWidth: '2px', borderColor: 'red', padding: '1rem' }}
                                onChange={(e) => setReason(e.target.value)} type="text" id="input2" className="form-control" />
                        </div>
                    </div>
                </div>
...
export default ReductionProduct;